...
export default function Productos({ productos }) {
	...
	return (
		<Layout>
			...
			<div className='w-3/4  mx-auto mt-10 xs:mt-3 xs:w-full xs:px-3'>
				<div className='xs:w-full w-3/4 flex flex-wrap gap-2 justify-center mx-auto'>
					{productos.map((product) => (
						<div
							className='mb-5 w-32 border-2 px-2 py-2 rounded-xl'
							key={product.id}
						>
							<div className=''></div>
							<img src={product.url} alt='img' className='rounded-lg' />
							<h5 className='text-lg font-bold mt-2 mb-1 xs:text-sm'>
								{product.name}
							</h5>
							{/* <div className='text'>
								<p>{product.desc}</p>
