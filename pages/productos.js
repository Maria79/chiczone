...
export default function Productos({ productos }) {
	...
	return (
		<Layout>
			...
			<div className='w-full  xs:mt-24 xs:w-full xs:px-3'>
				<div className='max-w-xl flex flex-wrap gap-2 justify-center mx-auto xs:w-full '>
					{productos.map((product) => (
						<div
							className='mb-5 mx-2 w-36 border-2 px-2 py-2 rounded-xl'
							key={product.id}
						>
							<div className=''></div>
